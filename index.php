<?php
$texto = file_get_contents('https://combovideos.com.br/prod/generateXmlFiles/xmlFiles_4YouSee/genUolEsportes_4YouSee.php');
...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* cena 2 */
        #elemento2 {
            background-image: url('./assets/template-top-button.png');
            background-repeat: no-repeat;
            position: absolute;
            top: 5%;
            width: 70%;
        ...
        #esportes {
            background-image: url('./assets/template-title.png');
            background-repeat: no-repeat;
            position: absolute;
            top: 5%;
            width: 100%;
        ...
        #cirmaior {
            background-image: url('./assets/template-half-circle-element.png');
            background-repeat: no-repeat;
            position: absolute;
            top: 10%;
            width: 100%;
...
<body>
    ...
    <div id="cena2">
        ...
        <!-- esportes -->
        <div id="esportes" class="animate__animated animate__delay-5s animate__fadeInDown"></div>
        <!-- circulo fino -->
